package com.example.hydraclient.filter;
...
public class LoggingFilter extends OncePerRequestFilter {
    ...
    private void doFilterWrapped(RequestWrapper request, ResponseWrapper response, FilterChain filterChain) throws ServletException, IOException{
        try {
            logRequest(request);
            filterChain.doFilter(request, response);
        } finally {
